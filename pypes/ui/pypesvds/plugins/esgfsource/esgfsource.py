...
class ESGFSource(Component):
    ...
    def __init__(self):
        ...
        self.set_parameter('Username', '', None, 'edu.utah.sci.vistrails.basic:String')
        self.set_parameter('Password', '', None, 'edu.utah.sci.vistrails.basic:String')
        self.set_parameter('Search Params', '', None, 'edu.utah.sci.vistrails.basic:String')
